				...
				case CS_BET_AREA:
					{
						...
						for(cbIndex=0;cbIndex<AREA_COUNT;cbIndex++)
						{
							if(m_bWinArea[cbIndex])
							{
								...
								switch(cbIndex)
								{
								case 0:str+=TEXT("天 ");break;
								case 1:str+=TEXT("地 ");break;
								case 2:str+=TEXT("玄 ");break;
								case 3:str+=TEXT("黄 ");break;
								default: break;
								}
							}
						}
...
BOOL CClientControlItemSinkDlg::OnInitDialog()
{
	...
	SetDlgItemText(IDC_CHECK_TIAN,TEXT("天"));		
	SetDlgItemText(IDC_CHECK_DI,TEXT("地"));		
	SetDlgItemText(IDC_CHECK_XUAN,TEXT("玄"));	
	SetDlgItemText(IDC_CHECK_HUANG,TEXT("黄"));	
