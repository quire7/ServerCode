...
//数组定义
typedef CYSArray<CGlobalUserItem *> CGlobalUserItemArray;
typedef CYSArray<CGlobalPlazaItem *> CGlobalPlazaItemArray;
typedef CYSArray<CGlobalServerItem *> CGlobalServerItemArray;
