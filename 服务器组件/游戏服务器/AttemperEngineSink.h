...
//数组说明
typedef CYSArray<CTableFrame *>		CTableFrameArray;					//桌子数组
typedef CYSArray<tagSystemMessage *>   CSystemMessageArray;             //系统消息
typedef CYSArray<tagTaskParameter *>   CTaskParameterArray;             //任务数组
