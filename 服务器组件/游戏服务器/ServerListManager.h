...
namespace NServerListManager
{
	...
	//数组说明
	typedef CYSArray<CGameTypeItem *> CGameTypeItemArray;
	typedef CYSArray<CGameKindItem *> CGameKindItemArray;
	typedef CYSArray<CGameNodeItem *> CGameNodeItemArray;
	typedef CYSArray<CGamePageItem *> CGamePageItemArray;
	typedef CYSArray<CGameServerItem *>	CGameServerItemArray;
