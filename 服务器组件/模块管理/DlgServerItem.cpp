...
bool CDlgServerItem::OpenGameServer(WORD wServerID)
{
	...
	//机器标识
	TCHAR szMachineID[LEN_MACHINE_ID] = TEXT("");
	CYSService::GetMachineID(szMachineID);
...
bool CDlgServerItem::GetModuleInitParameter(tagGameServerInfo * pGameServerInfo, bool bAutoMode)
{
	...
	//带入积分配置
	m_ModuleInitParameter.GameServiceOption.lDefPutScore = pGameServerInfo->lDefPutScore;
	m_ModuleInitParameter.GameServiceOption.lLowPutScore = pGameServerInfo->lLowPutScore;
	m_ModuleInitParameter.GameServiceOption.iExchangeRatio = pGameServerInfo->iExchangeRatio;

	//其他设置
	m_ModuleInitParameter.GameServiceOption.lMagicExpScore = pGameServerInfo->lMagicExpScore;
	m_ModuleInitParameter.GameServiceOption.lGratuityScore = pGameServerInfo->lGratuityScore;
	m_ModuleInitParameter.GameServiceOption.dwWinExperience = pGameServerInfo->dwWinExperience;
	m_ModuleInitParameter.GameServiceOption.dwFailExperience = pGameServerInfo->dwFailExperience;
	...
	////缓存服务器
	//lstrcpyn(m_ModuleInitParameter.GameServiceOption.szCacheServerAddr, pGameServerInfo->szCacheServerAddr, CountArray(m_ModuleInitParameter.GameServiceOption.szCacheServerAddr));
	//m_ModuleInitParameter.GameServiceOption.wCacheServerPort = pGameServerInfo->wCacheServerPort;
