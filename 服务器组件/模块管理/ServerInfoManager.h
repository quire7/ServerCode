...
//数组定义
typedef CYSArray<tagGameServerInfo *> CGameServerInfoArray;
typedef CYSArray<tagGameMatchOption *> CGameMatchOptionArray;
...
public:
	//获取参数
	bool GetAndroidParameter(WORD wServerID, CYSArray<tagAndroidParameter> & AndParameterAry);
	//删除参数
...
private:
	...
	//读取房间
	bool ReadGameServerInfo(SQLRecordset & PlatformDBAide, tagGameServerInfo & GameServerResult);
	//读取比赛
	bool ReadGameMatchOption(SQLRecordset & PlatformDBAide, tagGameMatchOption & GameMatchResult);
	//读取参数
	bool ReadAndroidParameter(SQLRecordset & PlatformDBAide, tagAndroidParameter *  pAndroidParameter);
};
