...
//停止线程
bool CYSThread::ConcludeThread(DWORD dwMillSeconds)
{
	//停止线程
	if (IsRuning()==true)
	{
...
//投递消息
LRESULT CYSThread::PostThreadMessage(UINT uMessage, WPARAM wParam, LPARAM lParam)
{
	//状态效验
...
//线程函数
unsigned __stdcall CYSThread::ThreadFunction(LPVOID pThreadData)
{
	//随机种子
	...
	CYSThread * pServiceThread=pThreadParameter->pServiceThread;
